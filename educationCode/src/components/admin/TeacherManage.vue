<template>
    <div class="all">
        <el-table :data="pagination.records" border>
            <el-table-column fixed="left" prop="teacherId" label="账号" width="180"></el-table-column>
            <el-table-column prop="teacherName" label="姓名" width="180"></el-table-column>
            <el-table-column prop="teacherPassword" label="密码" width="120"></el-table-column>
            <el-table-column prop="teacherPhone" label="联系方式" width="120"></el-table-column>
            <el-table-column prop="teacherEmail" label="邮箱" width="200"></el-table-column>
            <el-table-column prop="teacherType" label="职称" width="120"></el-table-column>
            <el-table-column prop="disabledFlag" label="状态" width="120"></el-table-column>
          ...
          <section class="update">
            <el-form ref="form" :model="form" label-width="80px">
              ...
              <el-form-item label="状态">
                <el-input v-model="form.disabledFlag"></el-input>
              </el-form-item>
