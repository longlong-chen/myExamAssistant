    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        <ul>
          ...
          <li>
            <span>所属课程：</span>
            <el-select v-model="form.courseId" placeholder="请选择所属课程" class="w150" @change="getChapterInfo($event)">
                <el-option
          ...
          <li>
            <span>所属章节：</span>
            <el-select v-model="form.chapterId" placeholder="请选择所属章节" class="w150">
                <el-option
          ...
          <li v-if="optionValue == '选择题'">
            <span>答案:</span>
            <el-select v-model="form.rightAnswer" placeholder="选择正确答案" class="w150">
              <el-option
        ...
        <div class="change judge" v-if="optionValue == '判断题'">
          ...
          <div class="judgeAnswer">
            <el-radio v-model="form.rightAnswer" label="T">正确</el-radio>
            <el-radio v-model="form.rightAnswer" label="F">错误</el-radio>
          </div>
          <div class="title">
            <el-tag>解析:</el-tag><span>在下面的输入框中输入题目解析</span>
            <el-input
        ...
        <div class="change fill" v-if="optionValue == '简答题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>输入题目,形如--简答线程和进程的区别。注意考生答题部分一定要尽可能的规范。</span>
            <el-input
              type="textarea"
              rows="4"
              v-model="form.question"
          ...
          <div class="title analysis">
            <el-tag type="success">答案:</el-tag><span>下方输入框中输入答案</span>
            <el-input
              type="textarea"
              rows="4"
    ...
    <el-tab-pane name="second">
      ...
      <div class="box">
        <ul>
          ...
          <li>
            <span>所属试卷：</span>
            <el-select v-model="paperId" placeholder="请选择所属试卷">
                <el-option
                    v-for="item in papers"
                    :key="item.paperId"
                    :label="item.paperName"
                    :value="item.paperId">
                    <span style="float: left">{{ item.paperName }}</span>
                    <span style="float: right; color: #8492a6; font-size: 13px">{{ item.paperId }}</span>
                </el-option>
            </el-select>
          </li>
          <li>
...
export default {
  ...
  methods: {
    ...
    // },
    getPapersInfo() {
      this.$axios(`/api/paperInfos`).then(res => {
